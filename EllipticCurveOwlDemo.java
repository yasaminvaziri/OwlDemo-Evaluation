...
import org.bouncycastle.math.ec.ECPoint;
    ...
    public class EllipticCurveOwlDemo {
        ...
        private void run () {
            ...
            double clientRegTime = (System.nanoTime() - tStart) / 1_000_000.0;
            ...
            System.out.println("[TIME] Client Registration Cost: " + clientRegTime + " ms\n");
            ...
            double serverRegTime = (System.nanoTime() - tStart) / 1_000_000.0;
            ...
            System.out.println("[TIME] Server Registration Cost: " + serverRegTime + " ms\n");
            ...
            double clientPass1Time = (System.nanoTime() - tStart) / 1_000_000.0;
            ...
            System.out.println("[TIME] Pass 1 Client Computation Cost: " + clientPass1Time + " ms\n");
...
//            }
            ...
            // --- PASS 2 (SERVER VERIFICATION) ---
            tStart = System.nanoTime();
            boolean checkX1 = verifyZKP(G, X1, zkpX1.getV(), zkpX1.getr(), userName);
            double verifyX1Time = (System.nanoTime() - tStart) / 1_000_000.0;
            if (checkX1) System.out.println("Server checks KP{x1}: OK [TIME: " + verifyX1Time + " ms]");

            tStart = System.nanoTime();
            boolean checkX2 = verifyZKP(G, X2, zkpX2.getV(), zkpX2.getr(), userName);
            double verifyX2Time = (System.nanoTime() - tStart) / 1_000_000.0;
            if (checkX2) System.out.println("Server checks KP{x2}: OK [TIME: " + verifyX2Time + " ms]");
            ...
            double serverPass2CompTime = (System.nanoTime() - tStart) / 1_000_000.0;
            ...
            System.out.println("[TIME] Pass 2 Server Computation Cost (X4, Beta, ZKPs): " + serverPass2CompTime + " ms\n");
...
//            }
            ...
            // --- PASS 3 (CLIENT VERIFICATION) ---
            tStart = System.nanoTime();
            boolean checkX3 = verifyZKP(G, X3, zkpX3.getV(), zkpX3.getr(), serverName);
            double verifyX3Time = (System.nanoTime() - tStart) / 1_000_000.0;
            if (checkX3) System.out.println("Client checks KP{x3}: OK [TIME: " + verifyX3Time + " ms]");

            tStart = System.nanoTime();
            boolean checkX4 = verifyZKP(G, X4, zkpX4.getV(), zkpX4.getr(), serverName);
            double verifyX4Time = (System.nanoTime() - tStart) / 1_000_000.0;
            if (checkX4) System.out.println("Client checks KP{x4}: OK [TIME: " + verifyX4Time + " ms]");

            tStart = System.nanoTime();
            boolean checkX4s = verifyZKP(GBeta, Beta, zkpX4s.getV(), zkpX4s.getr(), serverName);
            double verifyX4sTime = (System.nanoTime() - tStart) / 1_000_000.0;
            if (checkX4s) System.out.println("Client checks KP{x4*s}: OK [TIME: " + verifyX4sTime + " ms]");
            ...
            // --- PASS 3 (CLIENT COMPUTATION & KEY DERIVATION) ---
            tStart = System.nanoTime();
            ...
            double clientPass3CompTime = (System.nanoTime() - tStart) / 1_000_000.0;
            ...
            System.out.println("[TIME] Pass 3 Client Computation Cost (Alpha, r, KDF, MAC): " + clientPass3CompTime + " ms\n");
...
//            }
            ...
            // --- PASS 4 (SERVER VERIFICATION & COMPUTATION) ---
            tStart = System.nanoTime();
            boolean checkX2s = verifyZKP(GAlpha, Alpha, zkpX2s.getV(), zkpX2s.getr(), userName);
            double verifyX2sTime = (System.nanoTime() - tStart) / 1_000_000.0;
            if (checkX2s) System.out.println("Server checks KP{x2*s}: OK [TIME: " + verifyX2sTime + " ms]");

            // Start Server Computation Timer
            tStart = System.nanoTime();
            ...
            boolean isRValid = G.multiply(rValue).add(T.multiply(hServer.mod(n))).equals(X1);
            ...
            double serverPass4CompTime = (System.nanoTime() - tStart) / 1_000_000.0;
...
//                    X3, X4, X1, X2);
            ...
            System.out.println("Server verifies rValue and clientKCTag, derives keys, generates serverKCTag [TIME: " + serverPass4CompTime + " ms]\n");
            ...
            // --- PASS 4 (FINAL CLIENT VERIFICATION) ---
            tStart = System.nanoTime();

            BigInteger serverKCTag2 = this.deriveHMACTag(clientKCKey, "KC_1_V", serverName, userName,
                    X3, X4, X1, X2);

            double finalClientVerifyTime = (System.nanoTime() - tStart) / 1_000_000.0;
            ...
            System.out.println("Client checks serverKCTag (for explicit key confirmation): OK [TIME: " + finalClientVerifyTime + " ms]\n");
